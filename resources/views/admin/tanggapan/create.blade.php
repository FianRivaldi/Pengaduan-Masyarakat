                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form role="form" action="{{ route('tanggapan.store', $pengaduan->id_pengaduan) }}" method="POST">
                                            @csrf
                                            <div class="form-group">
                                                <label>Tanggal Tanggapan</label>
                                                <input class="form-control" name="tgl_tanggapan" type="date">

                                            </div>
                                            <div class="form-group">
                                                <label>Tanggapan</label>
                                                <input class="form-control" placeholder="Enter text" name="tanggapan">
                                            </div>
